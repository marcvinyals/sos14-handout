...
% Time-stamp: "2014-01-10, 15:17 (CET) Massimo Lauria"
% Encoding  : UTF-8
...
set of linear inequalities and linear equations. Linear program can be
assumed to have the following forms forms without loss of generality.
