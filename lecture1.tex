...
% Time-stamp: "2014-01-27, 17:25 (CET) Massimo Lauria"
% Encoding  : UTF-8
...
efficient algorithma to solve integer programs unless $\PTIME=\NP$,
which is considered by many to be very unlikely\footnote{Most of the
  hardness result we will see during the course won't rely on any
  unproved assumption. This of course does not apply for guest
  lectures.}.
