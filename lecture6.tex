...
\noindent We show how to give a good approximation for the max-cut problem using only low levels of the Lasserre hierarchy. This implies a separation between Sherali-Adams and Lasserre hierarchies. Additionally, we show how to obtain locally consistent solutions from intermediate polytopes and we introduce basic Fourier analysis definitions and properties.}
